...
class Gesture:
    ...
    def get_gestures_body_names() -> np.array:
        ...
        return np.array(
            [
                "Samasthiti",
                "Urdhva_Namashkarasana",
                "Uttanasana_A",
                "Uttanasana_B",
                "Chaturanga_Dandasana",
                "Urdhva_Mukha_Savanasana",
                "Adho_Mukha_Savanasana",
                "Utkatasana",
                "Virabhadrasana_A",
                "Padangusthasana",
                "Padahastasana",
                "Uttihita_Trikonasana",
                "Parivrtta_Trikonasana",
                "Uttihita_Parsvakonasana",
                "Parivrtta_Parsvakonasana",
                "Prasarita_Padottanasana_A",
                "Prasarita_Padottanasana_B",
                "Prasarita_Padottanasana_C",
                "Prasarita_Padottanasana_D",
                "Parsvottanasana",
                "Utthita_Hasta_Pasangusthasana_A",
                "Utthita_Hasta_Pasangusthasana_B",
                "Utthita_Hasta_Pasangusthasana_D",
                "Ardha_Baddha_Padmottanasana",
                "Virabhadrasana_B",
                "Dandasana",
                "Passchimottanasana_A",
                "Passchimottanasana_B",
                "Passchimottanasana_C",
                "Purvattanasana",
                "Ardha_Baddha_Padma_Paschimottanasana",
                "Triang_Mukha_Ekpada_Paschimottanasana",
                "Janu_Sirsasana_A",
                "Janu_Sirsasana_B",
                "Janu_Sirsasana_C",
                "Marichyasana_A",
                ...
                "Supta_Konasana_A",
                "Supta_Konasana_B",
                "Supta_Parsvasahita_A",
                "Supta_Parsvasahita_B",
                "Ubhaya_Padangusthasana",
                "Urdhva_Mukha_Paschimattanasana",
                "Setu_Bandhasana",
                "Urdhva_Dhanurasana",

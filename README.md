...
You can view the website at jscray.art, the website mostly just a stub. The website is a cloudfare CDN and is listening to the master branch and pointing to the "website" directory.
...
In order to start the web application navigate to the "website" directory and run "npx serve"
